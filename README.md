...
1. GitHub リポジトリにこの3ファイルを配置します。
2. Cloudflare Dashboard → Workers & Pages → 対象Pagesプロジェクトを開きます。
3. Settings → Variables and Secrets から Secret を追加します。
4. 名前を `NEWSAPI_KEY`、値をNews APIのAPIキーにします。
5. Production / Preview の必要な環境に設定します。
6. 再デプロイします。
